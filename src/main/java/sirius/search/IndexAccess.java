...
public class IndexAccess {
    ...
    private void startClient() {
        if ("embedded".equalsIgnoreCase(Sirius.getConfig().getString("index.type"))) {
            IndexAccess.LOG.INFO("Starting Embedded Elasticsearch...");
            ...
            IndexAccess.LOG.INFO("Starting In-Memory Elasticsearch...");
            generateEmptyInMemoryInstance();
        } else {
            IndexAccess.LOG.INFO("Connecting to Elasticsearch cluster '%s' via '%s'...",
